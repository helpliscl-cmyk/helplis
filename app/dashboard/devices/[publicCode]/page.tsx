...
export default async function DashboardDeviceDetailPage({
      ...
      <div className="grid gap-5">
        ...
        <Card className="grid gap-3 p-5">
          <CardHeader>
            ...
            <CardDescription>Inicia sesion con la cuenta propietaria o solicita acceso al responsable.</CardDescription>
          </CardHeader>
  ...
  const canReassign = activationState === "ACTIVE";
