        ...
        <section className="grid gap-5 lg:grid-cols-[1fr_360px] lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-lg leading-8 text-[var(--brand-muted)]">
              Pilotos y compras coordinadas para colegios, clubes, fundaciones, municipalidades y comunidades que necesitan identificar y reencontrar personas, mascotas u objetos de forma ordenada.
            </p>
            <div className="mt-6">
